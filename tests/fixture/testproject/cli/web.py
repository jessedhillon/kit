...
import testproject.lib.debug as debug
from testproject.core import BootConfiguration, di
from testproject.core.config import LoggingSettings, WebSettings
from testproject.core.provider import LoggingProvider
...
def develop(
    ...
    match app_name:
        ...
        case "example":
            cf = web_cf.example
            fe_root = root / "testproject/web/example/frontend"
            spec = "testproject.web.example:create_app"
    ...
    os.environ["__Test_BOOT"] = boot_cf.model_dump_json()
