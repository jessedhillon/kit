...
class ExtraFormatterSettings(BaseFormatterSettings):
    class_: t.Literal["testproject.lib.logging.ExtraFormatter"] = p.Field(alias="()")
    base: str
...
class LogstashFormatterSettings(BaseFormatterSettings):
    class_: t.Literal["testproject.lib.logging.logstash.LogstashFormatter"] = p.Field(alias="()")
    extra: dict[str, str]
    extra_prefix: str
...
class AsynchronousLogstashHandlerSettings(BaseHandlerSettings):
    class_: t.Literal["testproject.lib.logging.logstash.AsynchronousLogstashHandler"] = p.Field(alias="class")
    emit_args: bool
